...
$conn = new mysqli($servername, $username, $password, $dbname);
    ...
    $sqlSongs = "SELECT s.song_id, s.title, s.artist FROM songs s
                 INNER JOIN liked_song ls ON s.song_id = ls.song_id
                 INNER JOIN liked l ON ls.liked_id = l.liked_id
                 WHERE l.email_id = '$email'";
...
<?php else : ?>
    <div class="container">
        <div class="no-results">
            <div class="no-results-item">No liked songs found.</div>
...
<script>
    function redirectToSinglePlayer(songId) {
        window.location.href = 'http://localhost:8000/singlesong-9.php?song_id=' + encodeURIComponent(songId);
    }
</script>
...
<script>
    ...
    event.stopPropagation();
        ...
        xhr.open('GET', 'http://localhost:8000/store_song_id.php?song_id=' + songId, true);
    ...
    function displayPlaylist() {
        ...
        console.log("displayPlaylist function called");
    ...
    <script>
        ...
        options.forEach(function(option) {
            option.addEventListener('click', function() {
                console.log("you clicked option sushanth");
